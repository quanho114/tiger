...
export const HeroSection: FC<HeroSectionProps> = ({ onExploreMenu, onBookTable }) => {
  return (
    <section id="home" className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden bg-[#fbf9f6]">
      
      {/* Top Left Botanical Branch (Image A exact motif) */}
      <div className="absolute -top-6 -left-6 w-36 h-36 md:w-52 md:h-52 opacity-85 pointer-events-none z-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start text-left">
            ...
            <div className="flex items-center gap-3 mb-4">
              <span className="font-['Be_Vietnam_Pro',sans-serif] text-[12px] font-semibold tracking-[0.18em] uppercase text-[#000000]/65">
                ẨM THỰC ĐƯƠNG ĐẠI
              </span>
              <span className="w-12 h-[1.5px] bg-[#d2b68c]" />
            </div>

            {/* Main Headline: Noto Serif 72px desktop 700–800 line-height: 0.96 letter-spacing: -0.025em Deep Indigo #234386 */}
            <h1 className="font-['Noto_Serif',serif] text-[#234386] text-4xl sm:text-5xl lg:text-[72px] font-bold lg:font-extrabold leading-[1.0] tracking-[-0.02em] uppercase mb-4">
              MÓN VIỆT.<br />
              ĐẬM VỊ.<br />
              ĐẦY CẢM HỨNG.
            </h1>
            ...
            <div className="font-['Dancing_Script',cursive] text-2xl sm:text-[30px] text-[#ed7328] font-semibold leading-[1.15] -rotate-1 mb-6">
              Một bữa ăn ngon là một ngày tươi đẹp hơn.
            </div>

            {/* Body: Be Vietnam Pro 16px 400 line-height: 1.7 max-width around 560px */}
            <p className="font-['Be_Vietnam_Pro',sans-serif] text-[16px] text-[#000000]/75 font-normal leading-[1.7] max-w-[560px] mb-8">
              Tại TIGER, chúng tôi gìn giữ hương vị Việt qua những nguyên liệu tươi sạch và cách chế biến sáng tạo, 
              để mỗi bữa ăn là một trải nghiệm trọn vẹn, gần gũi mà đầy bất ngờ.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-5 sm:gap-6">
              <button
                ...
                className="font-['Be_Vietnam_Pro',sans-serif] inline-flex items-center gap-2.5 bg-[#234386] hover:bg-[#1a3468] text-white px-7 py-3.5 rounded-full font-semibold text-[14px] shadow-md hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 group"
              >
              ...
              <button
                type="button"
                onClick={onBookTable}
                className="font-['Be_Vietnam_Pro',sans-serif] inline-flex items-center gap-2.5 text-[#000000] hover:text-[#ed7328] text-[14px] font-semibold transition-colors group"
              >
                <div className="w-9 h-9 rounded-full bg-[#ffc400]/25 border border-[#ffc400] text-[#ed7328] flex items-center justify-center group-hover:scale-105 group-hover:bg-[#ffc400] group-hover:text-[#234386] transition-all">
          ...
          <div className="lg:col-span-6 relative flex justify-center items-center py-6 lg:py-0">
            ...
            <div 
              aria-hidden="true"
              className="absolute -left-6 top-8 w-[280px] sm:w-[380px] h-[340px] sm:h-[430px] bg-[#6aa8dc]/30 -z-10"
              style={{
            ...
            <div 
              aria-hidden="true"
              className="absolute -right-4 top-2 w-[260px] sm:w-[360px] h-[320px] sm:h-[410px] bg-[#ffc400]/35 -z-10"
              style={{
                borderRadius: '42% 58% 35% 65% / 55% 40% 60% 45%'
              }}
            />

            {/* Botanical Branches Sprouting From Plate */}
            <div className="absolute -top-12 left-10 w-32 h-32 pointer-events-none -z-10">
              <BotanicalBranch className="w-full h-full -rotate-15" color="#3d5a45" />
            </div>
            
            <div className="absolute -bottom-10 right-8 w-36 h-36 pointer-events-none -z-10">
            ...
            <StarDustDots className="absolute bottom-8 left-6 w-14 h-14 pointer-events-none -z-10" />

            {/* Floating Handwritten Notes with Curved Directional Arrows (Dancing Script 500-600) */}
            <div className="absolute -top-3 right-4 sm:right-10 z-20 flex flex-col items-end pointer-events-none">
            ...
            <div className="absolute -bottom-5 left-4 sm:left-10 z-20 flex flex-col items-start pointer-events-none">
            ...
            <div className="relative w-[310px] sm:w-[440px] md:w-[490px] aspect-square rounded-full overflow-hidden shadow-2xl border-[6px] border-[#fbf9f6] bg-[#234386]/5 group">
              <img
                src="https://images.unsplash.com/photo-1544025162-d76694265947?auto=format&fit=crop&w=1000&q=85"
                alt="Sườn nướng mật ong và ẩm thực tinh tế tại TIGER"
